...
chainsight-cdk-macros = {{ git = "https://github.com/horizonx-tech/chainsight-sdk.git", branch = "feature/anyrelayer" }}
chainsight-cdk = {{ git = "https://github.com/horizonx-tech/chainsight-sdk.git", branch = "feature/anyrelayer" }}
"#,
        members
            .iter()
            .map(|x| format!(r#""{}""#, x))
