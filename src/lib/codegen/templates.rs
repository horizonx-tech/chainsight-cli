...
ic-solidity-bindgen = {{ version = "0.1.7" }}
chainsight-cdk-macros = {{ git = "https://github.com/horizonx-tech/chainsight-sdk.git", rev = "27d4950a1ca1e25800691132fccfce65e2c39cc6" }}
chainsight-cdk = {{ git = "https://github.com/horizonx-tech/chainsight-sdk.git", rev = "27d4950a1ca1e25800691132fccfce65e2c39cc6" }}
"#,
        members
            .iter()
            .map(|x| format!(r#""{}/*""#, x))
