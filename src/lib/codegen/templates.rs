...
ic-solidity-bindgen = {{ git = "https://github.com/horizonx-tech/ic-solidity-bindgen.git", tag = "v0.1.9" }}
chainsight-cdk-macros = {{ git = "https://github.com/horizonx-tech/chainsight-sdk.git", rev = "3eade9b44be68c1b12a5d8a53326159430a62594" }}
chainsight-cdk = {{ git = "https://github.com/horizonx-tech/chainsight-sdk.git", rev = "3eade9b44be68c1b12a5d8a53326159430a62594" }}
"#,
        members
            .iter()
            .map(|x| format!(r#""{}""#, x))
